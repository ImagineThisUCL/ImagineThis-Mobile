...
<View style={{flex: 1}}>
<Image
source={require('../../assets/img/72.png')}
...
imageSrc={require('../../assets/img/73.png')}/>
</View>
</View>
...
style={{padding: 10}}
imageStyle={{width: 24, height: 23}}
imageSrc={require('../../assets/img/75.png')}/>
</View>
</View>
