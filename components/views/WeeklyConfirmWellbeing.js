...
class WeeklyConfirmWellbeing extends Component {
    render() {
        return (
            <ScrollView style={{ flex: 1, padding: 0, backgroundColor: "rgba(16,40,123,1.0)" }}>
                ...
                <View style={{ marginTop: 9, marginLeft: 8, marginRight: 14 }}>
                    <View style={{ borderRadius: 10.0, padding: 10, flex: 1, backgroundColor: "rgba(255,255,255,1.0)" }}>
                        <View style={{ flexDirection: 'row', marginTop: 21, justifyContent: "center" }}>
                            <CustomSlider
                ...
                <View style={{ padding: base.screenPadding, marginLeft: 160 }}>
                    <Button
                       ...
                       textStyle={{ color: "rgba(20,126,251,1.0)", fontSize: 26.0 }}>SAVE</Button>
                </View>
            </ScrollView>
        )
    }
